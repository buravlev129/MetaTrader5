                ...
                const int &spread[])
{
   ...
   datetime time_2 = D'2023.01.01 00:00';
   int index_1 = 1;
   time_1 = time[index_1];
   ...
   // GBPJPY
   CCandleRanges candle_range(6300, 160, 850, 1600, 2800, 350);     // H3
   ...
   if (index_1 > 0 && index_2 > index_1)
   {
      ...
      for(int i = 0; i < count; i++)
      {
         ...
         //CSignal s = treeMA.analyse(candles, k, u_sht, u_mid, u_lng);
         CSignal s = treeMA.Check_Bounce_Sht_Trend_Reversal(candles, k, u_sht, u_mid, u_lng, filterShtMidPosition, checkTrend, sig_no);
